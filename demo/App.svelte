<script lang="ts">
  import Tree from "../src/lib/Tree.svelte";
  import {
            ...
            >
              ...
              {/snippet}
							...
							{#snippet contextMenu(node, closeMenu)}
								<button class="ltree-context-menu-item" onclick={() => { console.log('View', node.path); closeMenu(); }}>
									📄 View File
								</button>
								<button class="ltree-context-menu-item" onclick={() => { console.log('Edit', node.path); closeMenu(); }}>
									✏️ Edit
								</button>
								<div class="ltree-context-menu-separator"></div>
								<button class="ltree-context-menu-item" onclick={() => { console.log('Copy path', node.path); closeMenu(); }}>
									📋 Copy Path
								</button>
								{#if node?.data?.type === 'file'}
									<button class="ltree-context-menu-item danger" onclick={() => { console.log('Delete', node.path); closeMenu(); }}>
										🗑️ Delete File
									</button>
								{/if}
							{/snippet}
          ...
          <div class="card">
            ...
            >
              ...
              {#snippet nodeTemplate(node)}
                ...
                <span class="node-path text-muted ms-2">
                  <code class="small bg-light px-1 rounded"
              ...
              {/snippet}
							...
							{#snippet contextMenu(node, closeMenu)}
								<button class="ltree-context-menu-item" onclick={() => { console.log('View org', node.path); closeMenu(); }}>
									👥 View Department
								</button>
								{#if node?.data?.manager}
									<button class="ltree-context-menu-item" onclick={() => { console.log('Contact manager:', node.data.manager); closeMenu(); }}>
										📧 Contact Manager
									</button>
								{/if}
								<div class="ltree-context-menu-separator"></div>
            ...
            <div class="col-md-6 mb-3 mb-md-0">
              <div class="card">
                ...
                >
                  ...
                  {#snippet contextMenu(node, closeMenu)}
                    <button class="ltree-context-menu-item" onclick={() => { console.log('View animal info:', node.data); closeMenu(); }}>
                      🔍 Animal Info
                    </button>
                    {#if node?.data?.type === 'animal'}
                      <button class="ltree-context-menu-item" onclick={() => { console.log('Feed animal:', node.data.name); closeMenu(); }}>
                        🥩 Feed Animal
                      </button>
                      <div class="ltree-context-menu-separator"></div>
                      <button class="ltree-context-menu-item" onclick={() => { console.log('Move to zone:', node.data.name); closeMenu(); }}>
                        🚚 Move to Zone
                      </button>
                    {/if}
                  {/snippet}
            ...
            <div class="col-md-6">
              <div class="card">
                ...
                >
                  ...
                  {#snippet contextMenu(node, closeMenu)}
                    <button class="ltree-context-menu-item" onclick={() => { console.log('Zone details:', node.data); closeMenu(); }}>
                      ℹ️ Zone Details
                    </button>
                    {#if node?.data?.type === 'subsection'}
                      <button class="ltree-context-menu-item" onclick={() => { console.log('View animals in:', node.data.name); closeMenu(); }}>
                        👀 View Animals
                      </button>
                      <div class="ltree-context-menu-separator"></div>
                      <button class="ltree-context-menu-item" onclick={() => { console.log('Clean zone:', node.data.name); closeMenu(); }}>
                        🧹 Clean Zone
                      </button>
                    {/if}
                  {/snippet}
